...
<!--
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a href="../admin/ikaslecsv.php"><span class="glyphicon glyphicon-play" aria-hidden="true"></span> Cargar CSV</a></li>
              <li><a href="../admin/ikaslefind.php"><span class="glyphicon glyphicon-search" aria-hidden="true"></span> Buscar</a></li>
